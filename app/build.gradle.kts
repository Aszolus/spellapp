...
android {
    ...
    androidResources {
        ignoreAssetsPattern = listOf(
            ...
            "builder.manifest.normalized.json",
            "class-features.normalized.json.gz",
            "feats.ancestry.normalized.json.gz",
            "feats.archetype.normalized.json.gz",
            "feats.class.normalized.json.gz",
            "feats.general.normalized.json.gz",
            "feats.index.normalized.json",
            "feats.skill.normalized.json.gz",
            "heritages.normalized.json",
            "rules.catalog.normalized.json",
